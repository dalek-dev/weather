...
import 'package:weather/utils/daily_forecast.dart';
import 'package:weather/utils/openweather_api.dart';
...
class _WeatherWidgetState extends State<WeatherWidget> {
  ...
  _fetchData() async{
    ...
    var currentTemperature  = await openWeatherAPI.getCurrentTemperature(lat, lon);
    var weatherForecast     = await openWeatherAPI.getWeatherForecast(lat,lon,_days);
    setState(() {
